...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public static final String USER = "com.example.alex.planningmadeeasy.USER";
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(password)) {
            mPasswordView.setError(getString(R.string.error_invalid_password_required));
            focusView = mPasswordView;
            cancel = true;
        ...
        if (cancel) {
            ...
            // REPLACE WITH REQURIED DATABASE CODE
            showProgress(true);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                if (myUser.userID > 0) {
                    finish();
                    Intent intent = new Intent(LoginActivity.this, GoalAcitivity.class);
                    intent.putExtra(USER, myUser.Username);
                            ...
                            switch (which){
                                case DialogInterface.BUTTON_POSITIVE:
                                    ...
                                    try{
                                        finish();
                                        dbTools = new DBTools(mContext);
                                        myUser=dbTools.createUser(myUser);
                                        Toast myToast = Toast.makeText(mContext,R.string.updating_report, Toast.LENGTH_SHORT);
                                        myToast.show();
                                        Intent myIntent = new Intent(LoginActivity.this,GoalAcitivity.class);
